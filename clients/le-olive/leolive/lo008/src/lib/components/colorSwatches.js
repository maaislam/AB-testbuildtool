...
export const colorSwatches = (id, data, THRESHOLD_IMAGE_NUMBER) => {
  ...
  const html = `
        <div class="${id}__colorSwatches">
            <div class="${id}__colorname"><span class="${id}__title">Color : </span><span class="${id}__color">${perSelectedColor}</span></div>
