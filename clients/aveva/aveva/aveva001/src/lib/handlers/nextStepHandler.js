...
const nextStepHandler = (id, nextBtnElem) => {
    ...
    if ((step1 === 'Services and Support') && currentStep === 1) { //support channel
        const dataForm = {
        ...
        //prefilledFormValues(id, 'support');
        ...
        //fire event: step 1 completes
        //sendAdobeEvent('Step 1 Complete');
        //fire event: get support form seen
        sendAdobeEvent('Form Step 1 Complete', 'event41');
    ...
    } else if ((step1 === 'Services and Support') && currentStep === 2) { //support channel - form submission & go to (thank you page)
        //hide step 1 and show step 2
        ...
        if (isFormValidated()) {
            ...
            //fire event: step 2 completes
            //Update DataLayer Object per client guidance
            //window.s.tl(true, 'o', dataForm.formStatus);
            sendAdobeEvent('Form Step 2 Complete', 'event42');
            updateDigitalData('form', dataForm);
            //window.digitalData.form.formStatus = 'Step 2 Complete';

            //fire event: get support thank you screen
    ...
    } else if ((step1 === 'Products' || step1 === 'Training') && currentStep === 1) { //sales channel (show form - first part)
        //hide step 1 and show step 2
        ...
        updateDigitalData('form', dataForm);
        //window.digitalData.form.formStatus = 'Step 1 Complete';
    } else if ((step1 === 'Products' || step1 === 'Training') && currentStep === 2) { //sales channel (show form - last part)
        ...
        if (isFormValidated()) {
            ...
            //fire event: step 3 completes
            sendAdobeEvent('Form Step 3 Complete', 'event43');

            //Update DataLayer Object per client guidance
            //window.s.tl(true, 'o', dataForm.formStatus);
            updateDigitalData('form', dataForm);

            //window.digitalData.form.formStatus = 'Success';
            sendAdobeEvent('Success - Custom Target Form', 'event48');
