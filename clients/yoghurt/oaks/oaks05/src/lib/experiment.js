  ...
  <div class="modal-window hidden">
    <div class="modal">
      ...
      <div class="modal-info">
        ...
        <h1 class="modal-title">Feel right <br/>at home</h1>
        <p class="modal-sub-title">Enjoy great spaces and all your favourite homely comforts including Foxtel and Deliveroo right to your door.</p>
        <div class="left-align_btn">
          <button class="find-hotel-btn" onclick="window.location.href='https://be.synxis.com/?_ga=2.164949885.332240232.1653260296-1242823349.1649397295&_gac=1.53416410.1650521645.Cj0KCQjw3v6SBhCsARIsACyrRAkVnNAucQsHXNRTQ1KaH-5uFHDn-GUGnQod_30PcGEOkchpuV3nW8kaAgAiEALw_wcB&adult=2&arrive=2022-07-27&brand=OAKS&chain=18336&child=0&config=OAKS&configcode=OAKS&currency=AUD&depart=2022-07-29&dest=AUS&level=chain&locale=en-US&rooms=1&start=availresults&theme=OAKS&themecode=OAKS'">Find A Hotel</button>
        </div>
      </div>
    </div>
  </div>`;
  ...
  if (window.location.pathname === '/en' || window.location.pathname === '/en/') {
    ...
    <div class="banner-image">
      ...
      <div class="banner-text-section">
        <p class="banner-header-title">FEEL RIGHT AT HOME WITH OAKS</p>
