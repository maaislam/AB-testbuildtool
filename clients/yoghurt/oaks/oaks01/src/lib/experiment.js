...
export default () => {
  ...
  <div class="modal-window hidden">
    <div class="modal">
      ...
      <div class="modal-info">
        ...
        <h1 class="modal-title">Book Now, Pay Later</h1>
        <p class="modal-sub-title">Bookings made easy with our flexible payment options.</p>
  ...
  if (window.location.pathname === '/en/' || window.location.pathname === '/' || window.location.pathname === '/en') {
    document.querySelector('.responsive-bg').classList.add(`hidden`);
    ...
    <div class="banner-image">
      ...
      <div class="banner-text-section">
        <img src="https://sandbox.echologyx.com/wp-content/uploads/2022/07/Easy-bookings.png" class="banner-header-text" />
        <p class="banner-header-title">Book now
        Pay later</p>
    ...
    document.querySelector('.responsive-bg').classList.remove(`hidden`);
    document.querySelector('.responsive-bg').classList.add(`show`);
