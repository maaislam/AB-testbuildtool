    ...
    if (computedInnerWidth > 767) {
      ...
      if (!document.querySelector('.rg-8-1-similar-container.lg-screen-bp')) {
        document
          ...
          .insertAdjacentHTML(
            'beforebegin',
            `<div class="${ID}-similar-container lg-screen-bp"><button type="button" id="prevSlideButton" class="prev-button-slider"><img src="https://sandbox.echologyx.com/wp-content/uploads/2022/07/icons8-arrow-24-1.png"/></button><div class="prod-wrapper">${similiarComponents.join(
              '\n'
      ...
      if (!document.querySelector('.rg-8-1-similar-container.sm-screen-bp')) {
        document
          ...
          .insertAdjacentHTML(
            'beforebegin',
            `<div class="${ID}-similar-container sm-screen-bp"><button type="button" id="prevSlideButton" class="prev-button-slider"><img src="https://sandbox.echologyx.com/wp-content/uploads/2022/07/icons8-arrow-24-1.png"/></button><div class="prod-wrapper">${similiarComponents.join(
              '\n'
            )}</div><button type="button" id="nextSlideButton" class="next-button-slider"><img src="https://sandbox.echologyx.com/wp-content/uploads/2022/07/icons8-arrow-24.png"/></button> <div class="product-indecator"><span></span><span></span><span></span></div></div>`
          );
      }
...
waitForEl(
  ...
  () => {
    ...
    //'#cart-table > tbody > tr > td.item-details > div.product-list-item > div.item-name-container > div'
    //);
    //const pdp = productName.querySelector('a').href;
    //productName.insertAdjacentHTML(
    //'beforeend',
    //`<div class="discount-banner"><a href="${pdp}">${productLists.message}</a></div>`
    //);
    //}
    try {
