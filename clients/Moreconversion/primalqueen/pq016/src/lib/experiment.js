...
const pdfUrl =
  'https://cdn.shopify.com/s/files/1/0805/3971/3813/files/Primal_Queen_COA-combined.pdf?v=1733152358';
...
const init = () => {
  ...
  targetElement.querySelectorAll('.package').forEach((item) => {
    if (!item.querySelector(`.${ID}__wrapper`)) {
      item.querySelector('.packge_button_outer').insertAdjacentHTML(
        'afterend',
