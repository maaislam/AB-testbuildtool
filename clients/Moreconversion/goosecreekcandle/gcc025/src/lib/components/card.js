const card = (id, data) => {
    const { image, title, variants, link } = data;
    ...
    style="visibility: visible; animation-name: fadeInUp;">
        <article class="indiv-product">
            <a class="grid__image"
                ...
                <img loading="lazy" class="" alt="${title}" width="2500" height="2500" src="${image?.src}">
            </a>
            <div class="hp-title">
                <a href="${link}"
                    ...
                    <span class="money-styling">
                        <span class="compare-at-price">
                            <span class="money">$${variants[0].compare_at_price}</span>
                        </span>
                        <span class="money">$${variants[0].price}</span>
                    </span>
                </a>
            </div>
        </article>
