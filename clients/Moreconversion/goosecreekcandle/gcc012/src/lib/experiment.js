...
const afterPayIcon = 'https://cdn.shopify.com/s/files/1/0016/9092/7179/files/afterpay-2024.png?v=1709375913';
...
const gcc012Template = () => `<div class="${ID}__container">
  ...
  <img src="${afterPayIcon}" alt="Afterpay Icon" style="width: 63px;"/>
  <span class="${ID}__tooltip">${infoIcon}</span>
</div>`;

const applyVariation = () => {
  !document.querySelector(`.${ID}__container`) && document.querySelector('#purchase').insertAdjacentHTML('afterend', gcc012Template());
