      ...
      if (
        ...
        if (document.querySelector('.percentage-text')) {
          document.querySelector(
            '.percentage-text'
          ).innerHTML = `-${swatchesDiscount}%`;
        }
      } else {
        document.querySelector(
          '.percentage-text'
        ).innerHTML = `-${tabWiseDiscount}%`;
      }
    }, 200);
    ...
    const callback = () => {
      if (
        ...
        if (
          ...
          if (document.querySelector('.percentage-text')) {
            document.querySelector('.percentage-text').innerHTML = `-${Math.round(
              document
                .querySelector('.ColorSwatch__Radio:checked')
        ...
        document
            .querySelector('.ProductMeta__PriceList .ProductMeta__Price')
            .classList.add('hidden');
        document.querySelector('.percentage-text').innerHTML = `-${document
          .querySelector('.DiscountTabsNavigation .Tab.-Active')
          .getAttribute(
            'data-discount'
          )}%`;
