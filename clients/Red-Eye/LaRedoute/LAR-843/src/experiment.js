...
import deliveryMessageFn from './lib/components/message';
...
export default () => {
  ...
  if (VARIATION == 1) {
    document
      .querySelector(`#globalPDPDetailsContainer .buttons-block .pdp-buttons`)
      .insertAdjacentHTML(`afterend`, deliveryMessageFn(ID, 'Delivery in 5-6 working days'));
  }
