...
const gaTracking = (label) => {
  ...
  const GA4_INTERNAL_EXPERIMENT_NUM = 'PEXCROAB-1074';
  const GA4_INTERNAL_EXPERIMENT_ID = `CRO - CF - Operator Banner & Position zero Update UI ${GA4_INTERNAL_EXPERIMENT_NUM}`;
