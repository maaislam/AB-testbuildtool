const chevron = `<svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M4.5 9L7.5 6L4.5 3" stroke="#00002A" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>`;
...
const addBreadcrumb = (id) => {
  ...
  !document.querySelector(`.${id}_breadcrumb-container`) && document.querySelector('.MuiContainer-root .mui-1cpixy9').insertAdjacentHTML('beforebegin', htmlStr);
};
