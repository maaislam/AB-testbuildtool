...
const init = () => {
  ...
  mainCard.forEach((card) => {
    ...
    mainCardTitleElement.textContent = onlyText;
    if (!mainButton.classList.contains(`${ID}__cardButton`)) {
