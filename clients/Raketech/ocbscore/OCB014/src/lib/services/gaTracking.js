...
const gaTracking = (label) => {
  ...
  const GA4_INTERNAL_EXPERIMENT_NUM = 'PEXCROAB-675';
  const GA4_INTERNAL_EXPERIMENT_ID = `CRO - OCB - Add Odds Manually to Matches with No Odds ${GA4_INTERNAL_EXPERIMENT_NUM}`;
