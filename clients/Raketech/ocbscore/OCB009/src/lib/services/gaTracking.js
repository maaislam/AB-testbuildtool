...
const gaTracking = (label) => {
  ...
  const GA4_INTERNAL_EXPERIMENT_NUM = 'PEXCROAB-523';
  const GA4_INTERNAL_EXPERIMENT_ID = `CRO - OCB - Match Page Optimization (2nd iteration) ${GA4_INTERNAL_EXPERIMENT_NUM}`;
