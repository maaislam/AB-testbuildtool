...
const gaTracking = (label) => {
  ...
  const GA4_INTERNAL_EXPERIMENT_NUM = 'PEXCROAB-437';
  const GA4_INTERNAL_EXPERIMENT_ID = `CRO - OCB - Homepage Page Carousel Optimization ${GA4_INTERNAL_EXPERIMENT_NUM}`;
