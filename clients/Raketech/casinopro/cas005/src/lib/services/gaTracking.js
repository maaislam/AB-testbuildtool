...
const gaTracking = (label) => {
  ...
  const GA4_INTERNAL_EXPERIMENT_NUM = '6996170597';
  const GA4_INTERNAL_EXPERIMENT_ID = `All Operators review page card opimization v2 ${GA4_INTERNAL_EXPERIMENT_NUM}`;
