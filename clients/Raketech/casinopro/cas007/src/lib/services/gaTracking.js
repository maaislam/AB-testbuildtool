...
const gaTracking = (label) => {
  ...
  const GA4_INTERNAL_EXPERIMENT_NUM = '7251320174';
  const GA4_INTERNAL_EXPERIMENT_ID = `Position 0 redesign "slider" ${GA4_INTERNAL_EXPERIMENT_NUM}`;
  const EXPERIMENT_DEVICE_CATEGORY = 'Mobile and Tablet Devices';
