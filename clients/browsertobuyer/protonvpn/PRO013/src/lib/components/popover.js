          ...
          <ul>
              ...
              <li>
                  <a class="${id}__featuresLink block p-4 text-purple-800 hover:text-purple-500 focus-visible:text-purple-500 hover:bg-purple-25 focus-visible:bg-purple-25">
                      ...
                      <p class="text-sm text-body">Learn how our advanced security and privacy features allow you to browse the web and stream your favourite content with peace of mind.</p>
                  </a>
              </li>
              <li>
