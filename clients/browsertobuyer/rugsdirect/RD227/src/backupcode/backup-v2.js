if (typeof (btbTestTracking) != "undefined" && btbTestTracking.running) { btbTestTracking.running.rd227 = "v2"; }
    ...
    data.mainText
                    ...
                    <div class="${id}__modal-body ${id}__mobile">
                        ...
                        <div class="${id}__mobile-modal-content">
                            <div class="${id}__modal-discount-mobile-heading">Extra 10% off all rugs</div>
